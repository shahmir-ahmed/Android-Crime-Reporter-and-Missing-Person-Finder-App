...
//                        String status = spinnerStatus.getSelectedItem().toString();
                        ...
                        try {
                            ...
                            values.put(DatabaseContract.MissingPersons.COL_REPORT_STATUS, newStatus);
                            ...
                            if (updatedRows != 1) {
                                ...
                                missingPersonData[position].setMissingPersonReportStatus(newStatus);// updating status record
